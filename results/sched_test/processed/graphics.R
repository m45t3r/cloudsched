...
google <- read.table(paste("./googlece_n8_temp.csv",sep=""),sep = ",",header = TRUE)
azure <- read.table(paste("./azure_n8_temp.csv",sep=""),sep = ",",header = TRUE)

setEPS()
    postscript(paste("eps/google.eps",sep=""))
...
setEPS()
    postscript(paste("eps/azure.eps",sep=""))
